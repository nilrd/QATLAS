...
const dict: Record<Lang, Record<string,string>> = {
  'pt-BR': {
    ...
    reportsTitle:'Relatórios', avgUpdateTime:'Tempo médio entre atualizações', totalCases:'Total de Casos', successRate:'Taxa de Sucesso', summaryByType:'Resumo por Tipo de Teste / Polaridade', typePolarity:'Tipo / Polaridade', total:'Total', passedCount:'Passaram', failedCount:'Falharam', blockedCount:'Impedidos', notExecutedCount:'Não Executados', downloadPDF:'Baixar Relatório (.PDF)', close:'Fechar',
  ...
  'es-ES': {
    ...
    reportsTitle:'Reportes', avgUpdateTime:'Tiempo promedio entre actualizaciones', totalCases:'Total de Casos', successRate:'Tasa de Éxito', summaryByType:'Resumen por Tipo de Prueba / Polaridad', typePolarity:'Tipo / Polaridad', total:'Total', passedCount:'Pasaron', failedCount:'Fallaron', blockedCount:'Impedidos', notExecutedCount:'No Ejecutados', downloadPDF:'Descargar Reporte (.PDF)', close:'Cerrar',
  ...
  'en-US': {
    ...
    reportsTitle:'Reports', avgUpdateTime:'Average time between updates', totalCases:'Total Cases', successRate:'Success Rate', summaryByType:'Summary by Test Type / Polarity', typePolarity:'Type / Polarity', total:'Total', passedCount:'Passed', failedCount:'Failed', blockedCount:'Blocked', notExecutedCount:'Not Executed', downloadPDF:'Download Report (.PDF)', close:'Close',
